...
#ifndef LIVEVIEW_SWIFT_H
#define LIVEVIEW_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="LiveView",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8LiveView19ChatvisorCoBrowsing")
@interface ChatvisorCoBrowsing : NSObject
- (void)startWith:(NSString * _Nonnull)tenantId and:(NSString * _Nonnull)token;
- (void)start;
- (void)stop;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC8LiveView22ChatvisorConfiguration")
...
SWIFT_CLASS("_TtC8LiveView17ChatvisorLiveView")
@interface ChatvisorLiveView : NSObject
/// Starts a LiveView session using the supplied user id and token
/// \param application UIApplication object of the app
///
/// \param userId The id of the tenant
///
/// \param token A token generated by the Chatvisor backend
///
- (void)startWith:(NSString * _Nonnull)userId and:(NSString * _Nonnull)token;
- (void)start;
...
/// Registers callbacks for start and stop
/// \param startCallback Called when a session is started by the remote server
///
/// \param stopCallback Called when a session is closed by the remove server
///
- (void)registerCallbacksForStart:(void (^ _Nonnull)(void))startCallback andStop:(void (^ _Nonnull)(void))stopCallback;
...
- (void)tag:(ActiveUser * _Nonnull)user callback:(void (^ _Nonnull)(BOOL))callback;
- (void)clear;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC8LiveView19CustomConfiguration")
