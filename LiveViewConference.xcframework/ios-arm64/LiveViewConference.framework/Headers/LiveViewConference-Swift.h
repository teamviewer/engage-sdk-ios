...
///
- (void)startWithConferenceProperties:(ConferenceProperties * _Nonnull)conferenceProperties;
/// Use this method to start a video conference in the app.
...
///
- (void)queueStatusWithCustomerId:(NSString * _Nonnull)customerId completion:(void (^ _Nonnull)(NSInteger))completion;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
